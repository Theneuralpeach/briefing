// Deno Deploy backend for the briefing app.
// Receives a note from the app and appends it to the Notion "アプリメモ" page.
...
Deno.serve(async (req) => {
  ...
  if (req.method === "GET") return json({ ok: true, service: "briefing-notes" });
